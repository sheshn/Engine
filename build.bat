...
rem Engine
cl /utf-8 /std:c++latest /DDEBUG /Od /W3 /Zi /MDd /EHsc /Fointermediates\ /nologo ..\%CURRENT_FOLDER%\platform\win32\%CURRENT_FOLDER%.win32.cpp kernel32.lib user32.lib /link /OUT:%CURRENT_FOLDER%.exe /INCREMENTAL:NO /NOLOGO /DEBUG
popd
