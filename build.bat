...
:: Vulkan Generator
:: clang ..\tools\%CURRENT_FOLDER%.vulkan.generator.cpp -o%CURRENT_FOLDER%.vulkan.generator.exe -D_CRT_SECURE_NO_WARNINGS -DUNICODE -O0 -g -gcodeview -gno-column-info -fno-cxx-exceptions -Wno-writable-strings -Wno-switch --for-linker -machine:x64 --for-linker -incremental:no --for-linker -opt:ref --for-linker -subsystem:console
